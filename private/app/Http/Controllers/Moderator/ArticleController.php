...
class ArticleController extends ModeratorController
{
    /**
    ...
    public function index()
    {
        ...
        return view('moderator.articles.index', [
            'articles' => $articles,
            'orderBy' => $orderBy,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('moderator.articles.edit', [$article->id]);
    }
    ...
    public function pay(Article $article)
    {
        ...
        return view('moderator.articles.pay', [
            'article' => $article,
        ]);
    }
    ...
    public function indexNewPending()
    {
        ...
        return view('moderator.articles.indexNewPending', [
            'articles' => $articles,
            'orderBy' => $orderBy,
        ]);
    }
    ...
    public function indexUpdatePending()
    {
        ...
        return view('moderator.articles.indexUpdatePending', [
            'articles' => $articles,
            'orderBy' => $orderBy,
        ]);
    }
