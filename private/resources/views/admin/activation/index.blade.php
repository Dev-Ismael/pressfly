...
@section('content')
    ...
    <div class="card card-primary card-outline">
        <div class="card-header">
            ...
            <h5 class="m-0"><i class="fas fa-shield-alt"></i> Continue To Admin Panal </h5>
        </div>
        <div class="card-body">
            ...
            <form method="post" action="{{ route('admin.activation.process') }}"
                ...
                <div class="form-group">
                    <button name="activation" type="submit" class="btn btn-danger"> Continue </button>
                </div>
