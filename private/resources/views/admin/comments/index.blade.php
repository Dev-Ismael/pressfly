                ...
                <table class="table table-striped">
                    ...
                    @foreach ($comments as $comment)
                        <tr>
                            ...
                            <td> <a href="https://topiclix.com/{{get_article_statuses($comment->article->slug)}}-{{get_article_statuses($comment->article->id)}}" target="_blank" >  http://topiclix.com/{{get_article_statuses($comment->article->slug)}} </a> </td>
